...
{
	if (region.W.E === region.ae.E)
	{
		return 'on line ' + region.W.E;
	}
	return 'on lines ' + region.W.E + ' through ' + region.ae.E;
}
...
var zwilias$elm_html_string$Html$String$node = F3(
	function (tag, attributes, children) {
		return zwilias$elm_html_string$Html$Types$Node.f(tag, attributes, zwilias$elm_html_string$Html$Types$Regular(children));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Overview$row.f(zwilias$elm_html_string$Html$String$text('total'), totals)
					]))
			]));
};
...
var zwilias$elm_html_string$Html$String$nodeWithoutChildren = F3(
	function (tag, attrs, _n0) {
		return zwilias$elm_html_string$Html$Types$Node.f(tag, attrs, zwilias$elm_html_string$Html$Types$NoChildren);
	});
...
var author$project$Markup$foldDeclarations = F3(
	function (moduleId, declaration, _n0) {
		...
		var declarationId = '#' + (moduleId + ('_' + elm$core$String$fromInt(declaration.X)));
		var formattedName = A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							zwilias$elm_html_string$Html$String$text(declaration.T)
						]))
				]));
			...
			if (!annotations.b) {
				...
				if (!annotations.a.b.$) {
					...
					var decl = {
						...
						D: complexity,
						T: name,
						X: author$project$Coverage$line(from)
					};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							author$project$Overview$row.f(zwilias$elm_html_string$Html$String$text(
								'(' + (elm$core$String$fromInt(
...
var author$project$Source$addRegion = F3(
	function (offsets, _n0, acc) {
		...
		return elm$core$Maybe$withDefault.f(acc, elm$core$Maybe$map2.f(F2(
            ...
            }), author$project$Coverage$positionToOffset.f(location.aQ, offsets), author$project$Coverage$positionToOffset.f(location.a6, offsets)));
	});
				...
				[
					...
					_List_fromArray(
						[
							...
							zwilias$elm_html_string$Html$String$node.f('meta', _List_fromArray(
								[
									A2(zwilias$elm_html_string$Html$String$Attributes$attribute, 'charset', 'UTF-8')
								]), _List_Nil)
						])),
					zwilias$elm_html_string$Html$String$node.f('body', _List_Nil, _List_fromArray(
						[
							A2(
		...
		return author$project$Styles$page.f('Coverage report', author$project$Analyzer$styles, version, A2(
            ...
            elm$core$List$filterMap.f(function (_n0) {
                ...
                return elm$core$Maybe$map.f(
                    ...
                    elm$core$Dict$get.f(key, model.ai)
                );
	...
	return elm$core$Platform$worker(
		{
			...
			a7: A2(author$project$Service$handle, settings.aR, settings.aN)
		});
};
		...
		switch (attribute.$) {
			case 0:
				...
				return _Utils_Tuple3(
					...
					A2(
						elm$core$List$cons,
						zwilias$elm_html_string$Html$Types$buildProp.f(key, value),
						attrs));
			case 1:
				if (attribute.a === 'className') {
					...
					return _Utils_Tuple3(
						...
						A2(
							elm$core$List$cons,
							zwilias$elm_html_string$Html$Types$buildProp.f(zwilias$elm_html_string$Html$Types$propName(string), value),
							attrs));
				}
			case 2:
				var string = attribute.a;
			...
			case 3:
				...
				return _Utils_Tuple3(
					...
					A2(
						elm$core$List$cons,
						zwilias$elm_html_string$Html$Types$buildProp.f(
                            zwilias$elm_html_string$Html$Types$propName(string),
...
var zwilias$elm_html_string$Html$Types$withClasses = F2(
	function (classes, attrs) {
		if (!classes.b) {
			...
			return A2(
				elm$core$List$cons,
				zwilias$elm_html_string$Html$Types$buildProp.f('class', zwilias$elm_html_string$Html$Types$join.f(' ', classes)),
				attrs);
		}
	});
var zwilias$elm_html_string$Html$Types$withStyles = F2(
	function (styles, attrs) {
		if (!styles.b) {
			...
			return A2(
				elm$core$List$cons,
				zwilias$elm_html_string$Html$Types$buildProp.f('style', zwilias$elm_html_string$Html$Types$join.f('; ', styles)),
				attrs);
		}
	});
var zwilias$elm_html_string$Html$Types$attributesToString = function (attrs) {
	...
	var styles = _n0.b;
	var regular = _n0.c;
	return zwilias$elm_html_string$Html$Types$withStyles.f(styles, zwilias$elm_html_string$Html$Types$withClasses.f(classes, regular));
};
								...
								acc,
								{
									g: A2(
										...
										A2(
											indenter,
											acc.e,
											zwilias$elm_html_string$Html$Types$tag.f(tagName, attributes)),
										acc.g)
								});
							indenter = $temp$indenter;
							tags = $temp$tags;
...
var zwilias$elm_html_string$Html$Types$toString = F2(
	function (depth, html) {
		...
		return zwilias$elm_html_string$Html$Types$join.f(
            joinString,
            zwilias$elm_html_string$Html$Types$toStringHelper.f(indenter, _List_fromArray(
                [html]), initialAcc).g
        );
	});
...
var author$project$Analyzer$main = author$project$Service$create(
	{
		aN: elm$json$Json$Encode$string,
		aR: F2(
			function (version, model) {
				return A2(
